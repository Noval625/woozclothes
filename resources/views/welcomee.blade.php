...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <!-- Favicons -->
        <link href="{{asset('Nova/assets/img/favicon.png')}}" rel="icon">
        <link href="{{asset('Nova/assets/img/apple-touch-icon.png')}}" rel="apple-touch-icon">
      ...
      <body class="page-index">
        ...
        <header id="header" class="header d-flex align-items-center fixed-top">
          <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo d-flex align-items-center">
              ...
              <h1 class="d-flex align-items-center">WOOZATH</h1>
            </a>
        ...
        <section id="hero" class="hero d-flex align-items-center">
          <div class="container">
            <div class="row">
              <div class="col-xl-4">
                <h2 data-aos="fade-up">WOOZATH CLOTHING</h2>
                <blockquote data-aos="fade-up" data-aos-delay="100">
                  <p>Sebuah Brand yang dibuat dengan angan angan terlebih dahulu sehingga menjadi brand nyata</p>
                </blockquote>
                <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                  <a href="login" class="me-3 btn-get-started">Login</a>
