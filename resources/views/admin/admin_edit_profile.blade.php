    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="alamat" class="form-control" type="text" value="{{ $editData->alamat }}"  id="example-text-input">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input name="no_tlp" class="form-control" type="text" value="{{ $editData->no_tlp }}"  id="example-text-input">
                </div>
            </div>
            <!-- end row -->
